...
class OrderActivity extends Model
{
    ...
    public const LABELS = [
        ...
        'redaksi_diubah' => 'Redaksi dikoreksi',
        'papan_pindah' => 'Pindah tahap',
        'papan_tugas' => 'Penanggung jawab tahap',
        'papan_tertahan' => 'Ditandai tertahan',
        'papan_lanjut' => 'Tidak tertahan lagi',
        'papan_tenggat' => 'Tenggat tahap diatur',
        'redaksi_item' => 'Redaksi item diubah',
